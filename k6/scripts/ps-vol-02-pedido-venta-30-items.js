...
const CLIENTE_ID = 3;
const N_ITEMS = 30; // exactamente 30, como pide PS-VOL-02
...
export default function () {
  ...
  let payload = {
    ...
    observacoes: 'PS-VOL-02 - 30 items k6',
  ...
  const res = http.post(`${BASE}/vendas/pedidovenda/adicionar/`, payload, {
    headers: { Cookie: `csrftoken=${csrf}`, Referer: `${BASE}/vendas/pedidovenda/adicionar/` },
    redirects: 0,
  });
  ...
  console.log('STATUS:', res.status, '| items enviados:', N_ITEMS);
  sleep(1);
}
